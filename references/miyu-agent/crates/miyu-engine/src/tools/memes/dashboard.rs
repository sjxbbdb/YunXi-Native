...
pub fn dashboard_libraries(config: &AppConfig, paths: &MiyuPaths) -> Result<Value> {
...
pub fn dashboard_list(paths: &MiyuPaths, library: &str) -> Result<Value> {
...
pub async fn dashboard_classify(
    config: &AppConfig,
    paths: &MiyuPaths,
    library: &str,
    id: &str,
