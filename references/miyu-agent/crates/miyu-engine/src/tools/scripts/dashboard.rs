...
pub fn scripts_dashboard_source(
    config: &AppConfig,
    paths: &MiyuPaths,
    id: &str,
    requested_path: &str,
...
pub fn scripts_dashboard_disable(config: &AppConfig, paths: &MiyuPaths, id: &str) -> Result<Value> {
...
pub fn scripts_dashboard_delete(config: &AppConfig, paths: &MiyuPaths, id: &str) -> Result<Value> {
    parse_result(unregister_script(
...
pub fn scripts_dashboard_enable(config: &AppConfig, paths: &MiyuPaths, id: &str) -> Result<Value> {
    let id = id.trim();
    if id.is_empty() {
        bail!("id is required");
    }
...
pub fn scripts_dashboard_register(
    config: &AppConfig,
    paths: &MiyuPaths,
    requested_path: &str,
    description: &str,
