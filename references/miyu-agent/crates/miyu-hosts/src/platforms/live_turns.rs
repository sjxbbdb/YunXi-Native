...
pub(crate) struct LiveTurnGuard {
    ...
    /// RAII:持有即登记,掉落即注销;没人读它。
    _host_tools_guard: crate::runtime::LiveTurnHostToolsGuard,
}

impl LiveTurnGuard {
    pub fn register(session_id: &str, context: &Arc<PlatformTurnContext>) -> Self {
        ...
        Self {
            ...
            context: weak,
            _host_tools_guard: crate::runtime::LiveTurnHostToolsGuard::register(
                session_id,
                context.host_tools_allowed(),
            ),
        }
    }
}
