...
use miyu_base::config::QqGroupManagementPluginSettings as Settings;
use miyu_core::state::PlatformPluginScopeKey;
...
impl GroupManagementPlugin {
    ...
    fn register_manage(
        ...
        registry.register(
            ...
            .writes()
            .with_display_name(miyu_base::i18n::text("QQ group management", "QQ群管理")),
        );
    }
